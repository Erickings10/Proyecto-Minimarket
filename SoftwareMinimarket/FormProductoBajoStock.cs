...
namespace SoftwareMinimarket
{
    public partial class FormProductoBajoStock : Form
    {
        ...
        private void FormProductoBajoStock_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void FormProductoBajoStock_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void FormProductoBajoStock_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        private void FormProductoBajoStock_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        private void FormProductoBajoStock_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        //-----------------------------------------------------------------------------------------------

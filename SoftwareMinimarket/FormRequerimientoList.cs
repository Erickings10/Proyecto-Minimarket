...
namespace SoftwareMinimarket
{
    public partial class FormRequerimientoList : Form
    {
        ...
        private void FormRequerimientoList_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void FormRequerimientoList_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void FormRequerimientoList_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void FormRequerimientoList_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void FormRequerimientoList_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        //-----------------------------------------------------------------------------------------------

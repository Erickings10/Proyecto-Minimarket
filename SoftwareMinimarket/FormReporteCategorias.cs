...
namespace SoftwareMinimarket
{
    public partial class FormReporteCategorias : Form
    {
        ...
        private void FormReporteCategorias_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void FormReporteCategorias_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void FormReporteCategorias_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        private void FormReporteCategorias_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        private void FormReporteCategorias_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        //---------------------------------------------------------------------------------------------

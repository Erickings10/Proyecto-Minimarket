...
namespace SoftwareMinimarket
{
    public partial class ModuloProveedor : Form
    {
        ...
        private void ModuloProveedor_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void ModuloProveedor_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void ModuloProveedor_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        private void ModuloProveedor_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        private void ModuloProveedor_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        //-------------------------------------------------------------------------------------------------
        ...
        private void btnNewRubro_Click(object sender, EventArgs e)
        {
